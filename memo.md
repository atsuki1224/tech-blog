...
```
ここはリモート風潮のある中ですので、変な方向に捉えられないように気をつけてサポートしてみます （編集済み）
```

```
執筆ありがとう！内容を確認しました。気になった点を以下に記載します。
研修中の資料の共有や質問などはここで行い、研修担当社員と個別な質問や相談をしたい場合など用に新入社員一人一人に他の研修メンバーが参加していない個人チャンネルもあり質問・相談はしやすいと感じました。
1文が長いので、分割した方が読みやすいです。
研修の資料はコンフルで整備されており、
略さず「Confluenceで整備されており」とした方がよいです。もしその後の文章で略記をするのであれば、「Confluence（以下「コンフル」と記載）」等としましょう。
前回のCommitから進捗が止まってしまっている場合には、何につまづいているのかなどサポートを行い、研修を進めていきました。
この1文には主語が混在しています。「サポートを行」うのは研修担当社員であり、「研修を進め」るのは新人ですよね。それがわかるように記載してみてください。
運動不足と心理的安全性
運動不足については記載がありますが、心理的安全性については記載されていますか？「心理的安全性」という言葉は、以前の朝会で長田さんからお話があったとおり、人によって都合よく解釈されがちな言葉ですので、改めて正確な意味を確認してみてください。
気をるけること
気をつけること
